...
options_map = {
    ...
    "constant_stream_target_qps": "target_qps",
    "constant_stream_target_latency_percentile": "target_latency_percentile",
}
...
def generate_mlperf_conf(mlperf_conf_path):
    shutil.copyfile("build/automotive/mlperf.conf", mlperf_conf_path)
...
def generate_user_conf(user_conf_path, scenario, flag_dict):
    ...
    required_settings_map = {
        ...
        Scenario.ConstantStream: ["constant_stream_target_qps"] + common_required,
    }
    ...
    optional_settings_map = {
        ...
        Scenario.ConstantStream: ["constant_stream_target_latency_percentile"] + common_optional,
    }
...
def generate_system_json(system_name, system_json_path, short_benchmark_name, input_dtype, precision):
    starting_weights_filename_map = {
        Benchmark.BEVFormer: "bevformer_tiny.onnx",
    }
    weight_transformations_map = {
        Benchmark.BEVFormer: "quantization, affine fusion",
    }
