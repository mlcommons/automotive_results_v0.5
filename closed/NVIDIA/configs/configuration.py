    ...
    def load_configs(benchmark: Benchmark, scenario: Scenario, ignore_custom: bool = False) -> bool:
        ...
        try:
            ...
            if ignore_custom:
                ...
                _custom_definition_path = os.environ.get("MLPAUTO_CUSTOM_DEFINITION_PATH", None)
                if _custom_definition_path is None:
                    logging.debug(f"MLPAUTO_CUSTOM_DEFINITION_PATH not set. Searching for custom configs in {base_module}.custom")
                    ...
                    raise FileNotFoundError(f"MLPAUTO_CUSTOM_DEFINITION_PATH {_custom_definition_path} does not exist.")
                else:
...
class BenchmarkConfiguration(object):
    ...
    A configuration is defined like follows:
        ...
        class MyConfiguration(<must have BenchmarkConfiguration somewhere in its inheritance chain>):
            ...
            batch_size = 64 * _N # This field uses _N to calculate it, and will be visible
            depth = _N + 1
            some_field = "value"
            ...
