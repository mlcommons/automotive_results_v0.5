...
DEFINE_uint32(dla_batch_size, 256, "Max Batch size to use for dla end-to-end inference");
...
std::map<std::string, mlperf::TestScenario> scenarioMap
    = {{"SingleStream", mlperf::TestScenario::SingleStream}, {"ConstantStream", mlperf::TestScenario::ConstantStream}};
