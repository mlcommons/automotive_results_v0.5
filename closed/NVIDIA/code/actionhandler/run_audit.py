...
class RunAuditHandler(RunHarnessHandler):
    ...
    def is_exempt(self):
        ...
        if self.test_name == AuditTest.TEST04:
            ...
            if self.benchmark_conf["benchmark"] in exclude_list:
                return True
        # if self.test_name == AuditTest.TEST06: # TODO: jsuh - TEST06 is for LLM, maybe future LLM workload will need this
        #     include_list = []
    ...
    def _handle_verify_test01(self):
        ...
        if "Accuracy check pass: True" in result and "Performance check pass: True" in result:
            ...
            baseline_script_path = os.path.join(G_MLCOMMONS_REPO_PATH,
                                                "compliance",
                                                "TEST01",
            ...
            verify_performance_script = os.path.join(G_MLCOMMONS_REPO_PATH,
                                                     "compliance",
                                                     "TEST01",
