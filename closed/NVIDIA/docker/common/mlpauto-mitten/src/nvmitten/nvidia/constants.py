...
from ..mlcommons.automotive.constants import AccuracyTarget, Benchmark
...
class WorkloadSetting:
    ...
    that MLPerf Automotive allows.
    """
    harness_type: HarnessType = HarnessType.LWIS
    """HarnessType: Harness to use for this workload. Default: HarnessType.LWIS"""
...
G_DEFAULT_HARNESS_TYPES: Dict[Benchmark, HarnessType] = {
    ...
    Benchmark.SSDResNet50: HarnessType.LWIS,
    Benchmark.DeepLabV3Plus: HarnessType.LWIS,
}
