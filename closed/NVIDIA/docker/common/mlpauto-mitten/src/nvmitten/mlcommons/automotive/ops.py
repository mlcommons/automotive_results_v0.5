...
class LoadgenWorkload(Operation):
    """Represents a LoadgenWorkload. Implementations should set up the necessary components for an MLPerf Automotive
    workload.
    """
    def __init__(self, flag_dict: Dict[str, Any]):
        ...
        flag_dict["scenario"] = flag_dict.get("scenario", "SingleStream")
