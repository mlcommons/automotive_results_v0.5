...
class LwisWorkload(LoadgenWorkload):
    """LWIS Loadgen Workload."""

    # TODO: jsuh: remove these flags as many as possible
    def __init__(self, flag_dict: Dict[str, Any]):
        ...
        self.flag_dict["run_infer_on_copy_streams"] = flag_dict.get("run_infer_on_copy_streams", True) # TODO: jsuh: automotive, always infer after sensor input
...
class LwisQSL(LoadgenQSL):
    ...
    def __init__(self, flag_dict: Dict[str, Any], test_settings: lg.TestSettings, sut: lwis_api.Server):
        ...
        # no NUMA in automotive; just one QSL
